package org.wangwei.excel.common;
...
public class Common {
    ...
    // common
    public static final String EXCEL_PATH = "src/main/resource/student_info.xls";
    public static final String CMSEXCEL_PATH = "src/main/resource/cms.xls";
    ...
    public static final String UPDATE_STUDENT_SQL =
            "update student_info set no = ?, name = ?, age= ?, score = ? where id = ? ";
