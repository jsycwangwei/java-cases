...
public class Footer {
    ...
    /**
     * Keyword replaced by the current page number. if COUNT_FIRSTPAGE is false, the first page will be number zero,
     * otherwise 1.
     *
    ...
    /**
     * Keyword replaced by the total number of pages in the document. If COUNT_FIRSTPAGE is false, the front page is
     * omittet from the count.
     *
     * @see #setCOUNT_FIRSTPAGE(boolean)
     */
    ...
    /**
     * Convenience function for returning a default footer style. The default footer typesets the footer in gray
     * TIMES_BOLD, sz 8. The left part of the text is todays date, center is username, and the right part is PAGENUM of
     * NUMPAGES
     */
    public static Footer defaultFooter = new Footer();

    /**
     * Sole constructor. Return a footer in gray TIMES_BOLD, sz 8. The left part of the text is todays date, center is
     * username, and the right part is PAGENUM of NUMPAGES
     */
    public Footer() {
