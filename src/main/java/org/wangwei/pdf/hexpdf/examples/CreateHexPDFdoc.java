...
public class CreateHexPDFdoc {
    ...
    private void createDocument() {
        String imgPath1 = "http://jira.vemic.com/s/en_US8j4anx-418945332/847/3/_/images/icon-jira-logo.png";
        String imgPath2 = "http://jira.vemic.com/s/en_US8j4anx-418945332/847/3/_/images/icon-jira-logo.png";
        ...
        doc.drawTable(table, new float[]{50, 100, 60, 70, 200}, new int[]{HexPDF.CENTER, HexPDF.LEFT, HexPDF.CENTER,
                HexPDF.RIGHT, HexPDF.LEFT}, HexPDF.CENTER);
        ...
        Object[][] tab =
                {
                        {null, "Country", "Area", "Population", "Info"},
                        {
                                getImage(
                                        base
                                                + "http://jira.vemic.com/s/en_US8j4anx-418945332/847/3/_/images/icon-jira-logo.png",
                                        50, 40), "Norway", "col2", "col2", "col4"},
                        {
                                getImage(
                                        base
                                                + "http://jira.vemic.com/s/en_US8j4anx-418945332/847/3/_/images/icon-jira-logo.png",
                                        50, 40), "Sweden", "col2", "col2", "col4"},
                        {
                                getImage(
                                        base
                                                + "http://jira.vemic.com/s/en_US8j4anx-418945332/847/3/_/images/icon-jira-logo.png",
                                        50, 40), "Denmark", "col2", "col2", "col4"},
                        {
                                getImage(
                                        base
                                                + "http://jira.vemic.com/s/en_US8j4anx-418945332/847/3/_/images/icon-jira-logo.png",
                                        50, 40), "Vietnam", "col2", "col2", "col4"},
                        {
                                getImage(
                                        base
                                                + "http://jira.vemic.com/s/en_US8j4anx-418945332/847/3/_/images/icon-jira-logo.png",
                                        50, 40), "Thaland", "col2", "col2", "col4"},
                        {
                                getImage(
                                        base
                                                + "http://jira.vemic.com/s/en_US8j4anx-418945332/847/3/_/images/icon-jira-logo.png",
                                        50, 40), "Burma", "col2", "col2", "col4"},
                        {
                                getImage(
                                        base
                                                + "http://jira.vemic.com/s/en_US8j4anx-418945332/847/3/_/images/icon-jira-logo.png",
                                        50, 40), "USA", "col2", "col2", "col4"},
                        {
                                getImage(
                                        base
                                                + "http://jira.vemic.com/s/en_US8j4anx-418945332/847/3/_/images/icon-jira-logo.png",
                                        50, 40), "Germany", "col2", "col2", "col4"}};
